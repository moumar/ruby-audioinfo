...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<ruby-mp3info>, [">= 0.7.1"])
      s.add_runtime_dependency(%q<ruby-ogginfo>, [">= 0.6.9"])
      ...
      s.add_dependency(%q<ruby-mp3info>, [">= 0.7.1"])
      s.add_dependency(%q<ruby-ogginfo>, [">= 0.6.9"])
